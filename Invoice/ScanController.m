...
-(void)configView{
    ...
    [UIUtil drawButtonInView:self.view frame:CGRectMake(0, 0, 60, 60) text:@"返回" font:[UIFont systemFontOfSize:18] color:[UIColor whiteColor] target:self action:@selector(clickBack)];
